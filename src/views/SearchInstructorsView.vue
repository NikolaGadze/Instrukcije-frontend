      ...
      <v-row>
        <v-col cols="12" xl="12" lg="12" md="12" sm="12" xs="12">
          <div class="text-center">
            ...
            <h5>filtrirati na ruti za filtraciju instruktora po određenim kategorijama.</h5>
          </div>
        </v-col>
            ...
            <div class="container-fluid">
              <v-text-field append-icon="mdi-magnify" placeholder="Pretražite korisnike po imenu, mjestu ili predmetu.." clearable multiple outlined class="rounded-xl" v-model="search"></v-text-field>
                ...
                <div class="d-flex justify-content-center">
                  <v-btn rounded color="primary" dark @click="searchInstructors()">
                      Pretraži!
                    </v-btn>
                </div>
        ...
        <v-col cols="12" xl="12" lg="12" md="12" sm="12" xs="12">
          <div class="text-center" v-if="show" @click="searchInstructors()">
            <v-pagination
...
import api from "@/plugins/api";
  ...
  methods: {
    ...
    api.get('api/auth/user').then(response => {
      ...
      searchInstructors() {
          api.get('api/auth/search-instructors?search=' + this.search + '&page=' + this.current_page).then(response => {
      if(response.status == 200) {

<template>
  <div class="home">
    <v-container fluid>
        ...
        <v-col cols="12">
          ...
          <p>
            Naziv projekta su Instrukcije, čiji je osnovni cilj studentima i učenicima omogućiti
             ...
             Ulogu korisnika imaju učenici i studenti koji su prijavljeni na sustav. Oni osim što mogu vidjeti potrebne informacije oni direktno mogu stupiti u kontakt
             sa predavačom preko aplikacije, i zabilježiti sebi mjesto, ako su im zadovoljeni ponuđenim predavačom, te su također u mogućnosti davati recenzije predavačima.
             Predavači također imaju ulogu korisnika, ali oni mogu objavljivati i uređivati svoje oglase i raspored. Administrator pregledava rad sustava i upravlja korisnicima.
          </p>
        </v-col>
      </v-row>
      ...
      <v-row style="color:white; font-size: x-large"> 
        <v-col cols="12">
          <h2 style="text-align:center; margin-bottom: 10px;">Motivacija za projekt</h2>
          <p>
           Motivaciju za ovaj projekt smo dobili jer smo i mi studenti i sami nekada imamo potrebu za pronalazak instrukcija.
            ...
            Ovim projektom želimo olakšati pronalazak dobrih i dostupnih predavača po željenim parametrima.
          </p>
        </v-col>
      </v-row>
